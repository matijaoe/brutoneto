...
export function grossToNet(gross: number, config?: GrossToNetConfig): number {
  ...
  console.log('pensionContribution', pensionContribution)
  ...
  console.log('personalAllowance', personalAllowance)
...
console.log(
  brutoToNeto(3150, {
    taxRateLow: PlaceTax['sveta-nedelja-samobor'].nizaStopa,
    taxRateHigh: PlaceTax['sveta-nedelja-samobor'].nizaStopa,
  }),
)
